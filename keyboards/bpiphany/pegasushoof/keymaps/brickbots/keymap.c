...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [KM_QWERTY] = LAYOUT( \
    KC_ESC,           KC_BRMD, KC_BRMU, KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_MRWD, KC_MPLY, KC_MFFD, KC__MUTE, KC__VOLDOWN, KC__VOLUP,KC_F13, KC_F14, KC_F15, \
    ...
    KC_LCTL, KC_LALT, KC_LGUI,                            KC_SPC,                             KC_RGUI, KC_LALT, MO(1),   KC_RCTL,      KC_LEFT, KC_DOWN, KC_RGHT  \
  ),
  /* Layer 1: Function layer */
  [KM_MEDIA] = LAYOUT( \
    RESET,            KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,     KC_WAKE, KC_PWR,  KC_SLEP, \
